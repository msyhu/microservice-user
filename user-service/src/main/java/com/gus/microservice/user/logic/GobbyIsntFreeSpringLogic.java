...
import com.gus.microservice.user.domain.logic.GobbyIsntFreeLogic;
...
public class GobbyIsntFreeSpringLogic extends GobbyIsntFreeLogic {

    public GobbyIsntFreeSpringLogic() {
        super();
